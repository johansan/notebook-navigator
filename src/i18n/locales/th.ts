    ...
    settings: {
        ...
        items: {
            ...
            sortNotesBy: {
                ...
                desc: 'เลือกลำดับการเรียงเริ่มต้นสำหรับโน้ต คุณสมบัติจาก “คุณสมบัติสำหรับเรียงลำดับและจัดกลุ่ม” จะปรากฏเป็นตัวเลือกการเรียงเพิ่มเติม',
                options: {
            ...
            groupNotes: {
                ...
                desc: 'กำหนดเองจะแสดงส่วนหัวที่กำหนดไว้ใน frontmatter วันที่จัดกลุ่มโน้ตตามวันที่ โฟลเดอร์จัดกลุ่มโน้ตตามโฟลเดอร์ มุมมองแท็กและคุณสมบัติจะใช้กลุ่มวันที่เมื่อเลือกโฟลเดอร์ คุณสมบัติจาก “คุณสมบัติสำหรับเรียงลำดับและจัดกลุ่ม” จะปรากฏเป็นตัวเลือกการจัดกลุ่มเพิ่มเติม',
                options: {
                    custom: 'กำหนดเอง',
                    date: 'วันที่',
                    folder: 'โฟลเดอร์'
