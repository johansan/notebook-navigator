    ...
    settings: {
        ...
        items: {
            ...
            sortNotesBy: {
                ...
                desc: 'اختر ترتيب الفرز الافتراضي للملاحظات. تظهر الخصائص من “خصائص الفرز والتجميع” كخيارات فرز إضافية.',
                options: {
            ...
            groupNotes: {
                ...
                desc: 'يعرض "مخصص" الرؤوس المعرفة في الواجهة الأمامية. يجمع "التاريخ" الملاحظات حسب التاريخ. يجمع "المجلد" الملاحظات حسب المجلد. تستخدم عروض الوسوم والخصائص تجميع التاريخ عند تحديد المجلد. تظهر الخصائص من “خصائص الفرز والتجميع” كخيارات تجميع إضافية.',
                options: {
                    custom: 'مخصص',
                    date: 'التاريخ',
                    folder: 'المجلد'
