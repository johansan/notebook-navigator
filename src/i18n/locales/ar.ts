    ...
    settings: {
        ...
        items: {
            ...
            defaultGrouping: {
                ...
                desc: 'تضيف **العناوين** توضيحات إلى القائمة المرتبة دون تغيير ترتيبها: يعرض "مخصص" العناوين المعرفة في البيانات الأمامية، ويدرج "التاريخ" عناوين التواريخ. تعيد **المجموعات** ترتيب القائمة: تُرتب مجموعات المجلدات والخصائص بشكل مستقل، وتتبع الملاحظات داخل كل مجموعة ترتيب الفرز.',
                families: {
                    headers: 'العناوين',
                    groups: 'المجموعات'
                },
            ...
            wordCountActiveNotice: {
                title: 'حساب الكلمات لا يزال مفعّلًا',
                summary: 'لا يزال عدد الكلمات يُحسب لجميع الملاحظات لأن العناصر التالية تستخدمه:',
                more: 'و{count} أخرى',
                reasons: {
