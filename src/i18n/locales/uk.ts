...
export const STRINGS_UK = {
    ...
    modals: {
        ...
        templateCommand: {
            ...
            fileNameFormatDesc:
                'Токени на кшталт {{date:YYYYMMDD}} і {{prompt:Назва}} замінюються під час запуску команди. Кожен запит просить значення, і та сама мітка в шаблоні отримує те саме значення.',
