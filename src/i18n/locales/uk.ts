    ...
    settings: {
        ...
        items: {
            ...
            sortNotesBy: {
                ...
                desc: 'Виберіть порядок сортування нотаток за замовчуванням. Властивості з «Властивості сортування та групування» відображаються як додаткові варіанти сортування.',
                options: {
            ...
            groupNotes: {
                ...
                desc: 'Користувацьке показує заголовки, визначені у frontmatter. Дата групує нотатки за датою. Папка групує нотатки за папкою. Перегляди тегів і властивостей використовують групи за датою, коли вибрано папку. Властивості з «Властивості сортування та групування» відображаються як додаткові варіанти групування.',
                options: {
