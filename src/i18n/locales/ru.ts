...
export const STRINGS_RU = {
    ...
    modals: {
        ...
        templateCommand: {
            ...
            fileNameFormatDesc:
                'Токены вроде {{date:YYYYMMDD}} и {{prompt:Название}} заменяются при запуске команды. Каждый запрос спрашивает значение, и та же метка в шаблоне получает то же значение.',
