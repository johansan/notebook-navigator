...
export const STRINGS_RU = {
    ...
    settings: {
        ...
        pageDescriptions: {
            ...
            appearanceBehavior: 'Шаблоны, поведение, навигация с клавиатуры, кнопки мыши, внешний вид и форматирование.',
            ...
            fileOperations: 'Подтверждения удаления, вложения и поведение при конфликтах перемещения файлов.',
        ...
        items: {
            ...
            calendarCustomFilePattern: {
                ...
                desc: 'Формат пути с использованием формата даты Moment. Заключайте названия подпапок в скобки, напр. [Work]/YYYY. Нажмите на значок шаблона, чтобы задать шаблон. Укажите расположение папки шаблонов в Внешний вид и поведение > Шаблоны.',
            ...
            showHoverPreview: {
                name: 'Показывать предпросмотр при наведении',
                desc: 'Показывать всплывающее окно с содержимым заметки при наведении. Требует включённого плагина "Предпросмотр страницы".'
            },
            resetPaneSeparator: {
