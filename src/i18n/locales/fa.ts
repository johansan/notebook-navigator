    ...
    settings: {
        ...
        items: {
            ...
            sortNotesBy: {
                ...
                desc: 'ترتیب پیش‌فرض مرتب‌سازی یادداشت‌ها را انتخاب کنید. ویژگی‌های «ویژگی‌های مرتب‌سازی و گروه‌بندی» به‌عنوان گزینه‌های مرتب‌سازی اضافی نمایش داده می‌شوند.',
                options: {
            ...
            groupNotes: {
                ...
                desc: 'سفارشی هدرهای تعریف‌شده در frontmatter را نمایش می‌دهد. تاریخ یادداشت‌ها را بر اساس تاریخ گروه‌بندی می‌کند. پوشه یادداشت‌ها را بر اساس پوشه گروه‌بندی می‌کند. نماهای برچسب و ویژگی هنگام انتخاب پوشه از گروه‌های تاریخ استفاده می‌کنند. ویژگی‌های «ویژگی‌های مرتب‌سازی و گروه‌بندی» به‌عنوان گزینه‌های گروه‌بندی اضافی نمایش داده می‌شوند.',
                options: {
                    custom: 'سفارشی',
                    date: 'تاریخ',
                    folder: 'پوشه'
