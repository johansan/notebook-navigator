...
export const STRINGS_JA = {
    ...
    settings: {
        ...
        items: {
            ...
            sortNotesBy: {
                name: 'デフォルトの並び順',
                desc: 'ノートのデフォルトの並び順を選択します。「並べ替えとグループ化に使うプロパティ」のプロパティが追加の並び順オプションとして表示されます。',
                options: {
            ...
            groupNotes: {
                name: 'デフォルトのグループ化',
                desc: 'カスタムは frontmatter で定義されたヘッダーを表示します。日付はノートを日付でグループ化します。フォルダはノートをフォルダでグループ化します。タグとプロパティビューでは、フォルダが選択されている場合は日付グループが使用されます。「並べ替えとグループ化に使うプロパティ」のプロパティが追加のグループ化オプションとして表示されます。',
                options: {
                    custom: 'カスタム',
                    date: '日付',
                    folder: 'フォルダ'
